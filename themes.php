...
<html lang="en">
	...
	<body>
		...
		<div>
			...
			<input type="button" name="newTheme" value="Créer un nouveau thème"
			onclick="cacherForm(this, 'formCreate', 'formModify', 'formDelete')">
			<input type="button" name="modifyTheme" value="Modifier un thème existant"
			onclick="cacherForm(this, 'formModify', 'formCreate', 'formDelete');
			afficherListe(this, 'affichageThemes');">
			<input type="button" name="deleteTheme" value="Supprimez un thème"
			onclick="cacherForm(this, 'formDelete', 'formModify', 'formCreate');
			afficherListe(this, 'affichageThemes')">
		</div>
