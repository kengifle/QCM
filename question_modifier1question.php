...
//requete pour afficher le label de la question a modifier
		...
		<?php
				...
				<td><input type="radio" name="<?php echo ('bonne_reponse'.$donnees2['id_reponse'])?>" value="1">Vrai<br></td>
				<td><input type="radio" name="<?php echo ('bonne_reponse'.$donnees2['id_reponse'])?>" value ="0">Faux<br></td>
				</tr><?php } ?>
			</tbody></table>
			<?php
