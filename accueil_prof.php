		...
		<div class=row>
			<div class="col-md 4">
				<div class="page-header">
					...
					<p><a href="question_ajouter.php">Voulez vous saisir une nouvelle question?</a>
						<p>
							<p><a href="question_supprimer1question.php">Voulez-vous supprimer une question?</a></p>
