...
<body>
	...
	<form action="traitement_valider_reponse.php" method="GET">
		<table border="1">
			...
			<tbody>
				<table>
					<tr>
						<td>
							<?php echo ("question no : ".$indice_question);
				...
				<table>
					...
					<tbody>
						<tr>
							<td>
								<?php echo ($indice_reponse." )".$donnees['label_reponse']); ?>
							</td>
							<td>
		...
		<select title="choississez dans la liste" <?php echo'name="liste_de_questions'.$indice_question.'">';?>>
