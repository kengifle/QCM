...
<html lang="en">
	...
	//REPONSES
		...
		$req_reponse1 = $linkpdo->prepare('INSERT INTO reponse (label_reponse, validite,id_question_fk) VALUES(
			:label_reponse1, :validite1, :id_question_fk)');
			///Exécution de la requête
		$req_reponse1->execute(array(
			'label_reponse1' => $label_reponse1,
			'validite1' => $validite1,
			'id_question_fk' => $_SESSION['id_question']));
	//reponse 2
		$label_reponse2="";
		$validite2=0;
		$label_reponse2 = $_POST['label_reponse2'];
		$validite2=$_POST['bonne_reponse2'];
		$req_reponse2 = $linkpdo->prepare('INSERT INTO reponse (label_reponse, validite,id_question_fk) VALUES(
			:label_reponse2, :validite2, :id_question_fk)');
			///Exécution de la requête
				$req_reponse2->execute(array(
			'label_reponse2' => $label_reponse2,
			'validite2' => $validite2,
			'id_question_fk' => $_SESSION['id_question']));
	//reponse 3
		$label_reponse3="";
		...
		$req_reponse3 = $linkpdo->prepare('INSERT INTO reponse (label_reponse, validite,id_question_fk) VALUES(
			:label_reponse3, :validite3, :id_question_fk)');
			///Exécution de la requête
		$req_reponse3->execute(array(
			'label_reponse3' => $label_reponse3,
			'validite3' => $validite3,
			'id_question_fk' => $_SESSION['id_question']));
	//reponse 4
		$label_reponse4="";
		...
		$req_reponse4 = $linkpdo->prepare('INSERT INTO reponse (label_reponse, validite,id_question_fk) VALUES(
			:label_reponse4, :validite4, :id_question_fk)');
			///Exécution de la requête
				$req_reponse4->execute(array(
			'label_reponse4' => $label_reponse4,
			'validite4' => $validite4,
			'id_question_fk' => $_SESSION['id_question']));
	}?>
	<body>
